...
import com.onlinelibrary.administration.exception.PaymentException;
import com.onlinelibrary.administration.repository.PaymentRepository;
...
public class PaymentService {
    ...
    public Payment findPaymentByUserEmail(String userEmail) {
        Payment payment = paymentRepository.findByUserEmail(userEmail);
